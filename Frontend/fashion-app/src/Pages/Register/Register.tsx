...
// register component responsible, call the backend server for user registration
const Register = () => {
        ...
        <section>
          ...
          <form>
            ...
            <label htmlFor="password">
              ...
              <FontAwesomeIcon
                icon={faCheck}
                className={validPwd ? "valid" : styles.hide}
              />
              <FontAwesomeIcon
                icon={faTimes}
            ...
            <label htmlFor="confirm_pwd">
              ...
              <FontAwesomeIcon
                icon={faCheck}
                className={validMatch && matchPwd ? "valid" : styles.hide}
              />
              <FontAwesomeIcon
                icon={faTimes}
                className={
